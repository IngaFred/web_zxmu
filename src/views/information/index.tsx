...
export default function Information() {
  const teachers = [{
    ...
    content: '组织课程设计与理论授课,浙江省护理学会副理事长，省高等学校护理学类教指委秘书长，中华护理学会护理教育专业委员会委员等；为省一流专业建设点（助产学）负责人，省大学生校外实践教育示范基地负责人、省课程思政教研团队主要成员及校护理实践教学创新团队、助产课程思政教学创新团队、《助产人文关怀》慕课和校课程思政示范课负责人；获省教学成果二等奖1项（2/5），校教学成果一等奖2项、二等奖1项（1/5）；主持省虚拟仿真实验项目2项、省教改项目4项；主编教材4部、副主编6部。'
