...
export default function Show() {
	...
	const handleBtn = (myGoodHomework: GoodHomework, showHomework: ShowHomework) => {
		navigate('/showDetail', { state: { myGoodHomework: myGoodHomework, showHomework: showHomework } });
	};
